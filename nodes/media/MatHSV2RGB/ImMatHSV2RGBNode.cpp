...
{
    BP_NODE_WITH_NAME(MatHSV2RGBANode, "ColorConv HSV2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatHSV2RGBANode(BP* blueprint): Node(blueprint) { m_Name = "ColorConv HSV2RGBA"; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatHSV2RGBANode, "ColorConv HSV2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
