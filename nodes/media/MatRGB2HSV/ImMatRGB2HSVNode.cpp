...
{
    BP_NODE_WITH_NAME(MatRGBA2HSVNode, "ColorConv RGBA2HSV", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatRGBA2HSVNode(BP* blueprint): Node(blueprint) { m_Name = "ColorConv RGBA2HSV"; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatRGBA2HSVNode, "ColorConv RGBA2HSV", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
