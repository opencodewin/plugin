...
{
    BP_NODE_WITH_NAME(MatRGBA2LABNode, "ColorConv RGBA2LAB", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatRGBA2LABNode(BP* blueprint): Node(blueprint) { m_Name = "ColorConv RGBA2LAB"; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatRGBA2LABNode, "ColorConv RGBA2LAB", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
