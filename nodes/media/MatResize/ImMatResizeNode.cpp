...
{
    BP_NODE_WITH_NAME(MatResizeNode, "Image Resize", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatResizeNode(BP* blueprint): Node(blueprint) { m_Name = "Image Resize"; m_HasCustomLayout = true; m_Skippable = true; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatResizeNode, "Image Resize", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
