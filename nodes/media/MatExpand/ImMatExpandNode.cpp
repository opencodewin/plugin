...
{
    BP_NODE_WITH_NAME(ExpandNode, "Image Expand", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    ExpandNode(BP* blueprint): Node(blueprint) { m_Name = "Image Expand"; m_HasCustomLayout = true; m_Skippable = true; }
...
BP_NODE_DYNAMIC_WITH_NAME(ExpandNode, "Image Expand", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
