...
{
    BP_NODE_WITH_NAME(MatLAB2RGBANode, "ColorConv LAB2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatLAB2RGBANode(BP* blueprint): Node(blueprint) { m_Name = "ColorConv LAB2RGBA"; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatLAB2RGBANode, "ColorConv LAB2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
