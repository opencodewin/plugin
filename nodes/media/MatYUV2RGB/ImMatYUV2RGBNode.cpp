...
{
    BP_NODE_WITH_NAME(MatYUV2RGBANode, "ColorConv YUV2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatYUV2RGBANode(BP* blueprint): Node(blueprint) 
    {
#if !IMGUI_VULKAN_SHADER
        m_mat_device_type = -1;
#endif
        m_Name = "ColorConv YUV2RGBA";
    }
...
BP_NODE_DYNAMIC_WITH_NAME(MatYUV2RGBANode, "ColorConv YUV2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
