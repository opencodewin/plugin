...
{
    BP_NODE_WITH_NAME(MatRGBA2HSLNode, "ColorConv RGBA2HSL", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatRGBA2HSLNode(BP* blueprint): Node(blueprint) { m_Name = "ColorConv RGBA2HSL"; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatRGBA2HSLNode, "ColorConv RGBA2HSL", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
