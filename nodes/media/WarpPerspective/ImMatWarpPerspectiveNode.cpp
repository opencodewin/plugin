...
{
    BP_NODE_WITH_NAME(MatWarpPerspectiveNode, "Image Warp Perspective", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatWarpPerspectiveNode(BP* blueprint): Node(blueprint) {
        m_Name = "Image Warp Perspective";
...
BP_NODE_DYNAMIC_WITH_NAME(MatWarpPerspectiveNode, "Image Warp Perspective", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
