...
{
    BP_NODE_WITH_NAME(MatRGBA2YUVNode, "ColorConv RGBA2YUV", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatRGBA2YUVNode(BP* blueprint): Node(blueprint) { m_Name = "ColorConv RGBA2YUV"; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatRGBA2YUVNode, "ColorConv RGBA2YUV", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
