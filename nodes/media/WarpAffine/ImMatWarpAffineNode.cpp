...
{
    BP_NODE_WITH_NAME(MatWarpAffineNode, "Image Warp Affine", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatWarpAffineNode(BP* blueprint): Node(blueprint) {
        m_Name = "Image Warp Affine";
...
BP_NODE_DYNAMIC_WITH_NAME(MatWarpAffineNode, "Image Warp Affine", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
