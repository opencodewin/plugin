...
{
    BP_NODE_WITH_NAME(MatHSL2RGBANode, "ColorConv HSL2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "Media")
    MatHSL2RGBANode(BP* blueprint): Node(blueprint) { m_Name = "ColorConv HSL2RGBA"; }
...
BP_NODE_DYNAMIC_WITH_NAME(MatHSL2RGBANode, "ColorConv HSL2RGBA", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "Media")
