...
#include <realsr.h>
#include "SimpleFaster_data.h"

#define NODE_VERSION    0x01000000

namespace BluePrint
{
struct UpScaleSimpleFasterNode final : Node
{
    BP_NODE_WITH_NAME(UpScaleSimpleFasterNode, "RealWorld Upscale Faster", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, NodeType::External, NodeStyle::Default, "AIFilter#Video#Upscaling")
    UpScaleSimpleFasterNode(BP* blueprint): Node(blueprint) 
    { 
        m_Name = "RealWorld Upscale Faster";
        m_HasCustomLayout = true;
        m_Skippable = true;
        m_BGRequired = true;
    }
    ~UpScaleSimpleFasterNode()
    {
    ...
    void PreLoad() override
    {
        ...
        if (m_realsr) { delete m_realsr; m_realsr = nullptr; }
        m_realsr = new RealSR(NomosUni_compact_otf_medium_x2_param_bin, NomosUni_compact_otf_medium_x2_param_bin_size, NomosUni_compact_otf_medium_x2_bin, NomosUni_compact_otf_medium_x2_bin_size,
...
BP_NODE_DYNAMIC_WITH_NAME(UpScaleSimpleFasterNode, "RealWorld Upscale Faster", "CodeWin", NODE_VERSION, VERSION_BLUEPRINT_API, BluePrint::NodeType::External, BluePrint::NodeStyle::Default, "AIFilter#Video#Upscaling")
